              ...
              <div class="copyright">
                <p style="width:300px;margin-left:40%">
                  蜀ICP备2023004978号
                   ...
                   <p>
                    <a target="_blank"
                     href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=50011302001914"
                    style="display:inline-block;text-decoration:none;height:20px;line-height:20px;margin-left:30%">
                    <img src="@/assets/user/ICP.png" style="float:left;"/>
                    <p style="float:left;height:20px;line-height:20px;margin: 0px 0px 0px 5px; color:#ffffff;">渝公网安备 50011302001914号</p>
                    </a>
                </p>
              </div>
