  ...
  <div style="position: relative">
        ...
        >
          <div class="menu-container">
            ...
            <div class="menu-item animate__animated animate__lightSpeedInRight">
              ...
              >
                <span slot="reference">
                  <svg-icon icon-class="github-fill" class="icon" />
                  本站源码（前端）
                </span>
              </el-popconfirm>
            </div>
    ...
    <div>
          ...
          <el-steps direction="vertical" :active="1" :space="50">
            <el-step v-for="(item, index) in recordList" :key="index">
              <h5 slot="title" style="color: #409eff">
                {{ item.describe }}
                <el-tag effect="dark" size="mini">{{ item.version }}</el-tag>
              </h5>
              <p slot="description" style="color: #409eff">
                {{ item.create_time }}
              </p>
            </el-step>
          </el-steps>
      ...
      >
        <div class="contactus">
          <div>
            <img width="150px" height="220px" :src="imgs.QQ" alt="QQ" />
          </div>
          <div>
            <img width="150px" height="220px" :src="imgs.WX" alt="WX" />
          </div>
        </div>
      </el-dialog>
    </div>
