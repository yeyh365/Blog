 ...
 * @LastEditors: Yerik
 * @LastEditTime: 2023-02-01 21:45:58
-->
<template>
  <div class="app-container">
    <div class="container">
      ...
      <div
        ...
        v-if=!isOk
      >
        <div> Yerik个人博客采用邮箱注册登录方式，如若您丢失密码，且不记得注册邮箱，请联系作者提供自己的相关信息，如用户名、电话、发布的文章、资源等信息，作者在后台帮你重置密码！本博客在设计之初就承诺不会强迫用户提供较多的个人信息，烦请谅解！</div>
      </div>
